...
func generateRating() {
	...
	// Note: This project is teaching complex structures, but normally when code becomes this nested,
	// you want to refactor and start putting code into other functions.
